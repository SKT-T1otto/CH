...
_BASE_REQUIRED_FILES = (
    ...
    "core/env/base_env.py",
    "core/env/uav_env.py",
    "core/mapping/map_module.py",
    "core/algorithms/agents.py",
    "core/algorithms/networks.py",
    "core/algorithms/noise.py",
    "core/algorithms/misc.py",
    "core/replay/ch3_buffer.py",
    "core/scenarios/ch3_generator_impl.py",
    "core/scenarios/ch3_generator_impl.py",
    "core/scenarios/ch3_generator_impl.py",
)
_BASE_DIRECTORIES = ("core/algorithms", "core/communication", "core/registry")

# S-profile mission behavior beyond the legacy base scope.
_MISSION_EXTENSION_FILES = (
    "core/config/ch3_config.py",
    "core/config/ch3_constants.py",
